...
export function TutorialOverlay() {
  ...
  // When all steps complete, mark the stage done and return to the lobby. From
  // there the player can pick the next stage or launch the bot test match
  // themselves (unlocked once the final stage is complete).
  useEffect(() => {
